...
function slidebar($active)
{
    ...
    <aside id="sidebar"
        class="fixed md:static z-50 w-64 h-full md:h-auto bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transform -translate-x-full md:translate-x-0 transition-transform duration-300 overflow-y-auto">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                <div class="text-right hidden sm:block">
                    <p class="text-sm font-semibold"><?= $data1['name'] ?></p>
