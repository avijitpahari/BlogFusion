...
<body class="bg-customBg text-customText min-h-screen flex items-center justify-center p-4">
    ...
    <main class="max-w-md w-full glass-effect rounded-2xl shadow-xl overflow-hidden border border-white/20"
        ...
        <!-- END: Header Section -->
        <!-- BEGIN: Signup Form -->
        <form action="#" class="p-8 space-y-6" data-purpose="signup-form" method="POST">
            <!-- Full Name Field -->
            <div>
                ...
                <div class="flex-1">
                    ...
                    <div class="relative">
                        <input
                            ...
                            id="otp" name="otp" placeholder="123456" type="text" />
                        <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 text-xs font-mono">
                            02:00
                        </span>
                    </div>
                </div>
            ...
            <div class="space-y-3" data-purpose="role-selector">
                <label class="block text-sm font-semibold mb-2">Join as <span
                        class="text-primary transition-all duration-300" id="role-text">User</span></label>
                <div class="relative flex p-1 bg-gray-100 rounded-xl border border-gray-200 w-full">
                    <!-- Sliding Background Highlight -->
                    <div class="absolute top-1 left-1 bottom-1 w-[calc(50%-4px)] bg-white rounded-lg shadow-sm transition-transform duration-300 ease-out transform translate-x-0"
                        id="role-highlight"></div>
                    <!-- Buttons -->
                    <button
                        class="relative flex-1 py-2 text-sm font-bold transition-colors duration-300 text-primary z-10"
                        id="btn-user" type="button">
                        USER
                    </button>
                    <button
                        class="relative flex-1 py-2 text-sm font-bold transition-colors duration-300 text-gray-500 z-10"
                        ...
                        <div class="block" id="upload-placeholder">
                            ...
                            <div class="flex text-sm text-gray-600 justify-center">
                                <label
                                    ...
                                    <input accept="image/*" class="sr-only" id="file-upload" name="file-upload"
            ...
            <p class="text-center text-sm text-gray-500 mt-4">
                ...
                <a class="text-accent font-semibold hover:underline" href="#">Log in</a>
            </p>
        </form>
        <!-- END: Signup Form -->
    </main>
